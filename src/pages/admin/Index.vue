  ...
  <q-page padding>
        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions elevated class="bg-grey-3">
              <div class="text-h6">Data Transaksi Penjualan</div>
              detail data transaksi user
            </q-banner>
          </div>
        </div>
      </div>
        ...
        <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="aksi" :props="props">
                <q-btn label="Detail" @click="openDetail(props.row)" unelevated color="blue-grey-13"/>
                <q-btn label="Konfirmasi" :disable="props.row.status !== 1" @click="konfirmasi(props.row._id)" class="q-ml-md" unelevated color="green-4"/>
              </q-td>
            </q-tr>
        </template>
      </q-table>
    ...
    >
      <q-card style="width: 700px; max-width: 80vw;">
        <q-card-section>
          <div class="text-h6">Detail Product</div>
        </q-card-section>
